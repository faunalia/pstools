...
def name():
    return "Processing PS Tools provider"

def description():
    return "Expose PS Tools to Processing."
...
def classFactory(iface):
    from pstools.PSToolsProviderPlugin import PSToolsProviderPlugin
    return PSToolsProviderPlugin()
